...
const HeroTyped = () => {
  return (
    <div
      ...
      style={{
        background: `url('/images_optimized/hero/hero-graphics.svg'), linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #FFFFFF 100%), rgba(221, 218, 255, 0.3)`,
          ...
          <Col xl={7} lg={7} md={12}>
            <div className="py-8 py-lg-0 text-center">
              ...
              <Link href="/marketing/pages/pricing">
                <a className="btn btn-primary me-2">View Plans</a>
              </Link>
              <Link href="/authentication/sign-up">
                <a className="btn btn-outline-primary">Try for Free</a>
              </Link>
