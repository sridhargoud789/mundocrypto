        ...
        <Row>
          <Col xl={6} lg={6} md={12}>
            <div className="mb-4 mb-xl-0 text-center text-md-start">
              ...
              <Link href="#">
                <a className="popup-youtube btn btn-white btn-lg fs-4">
                  Watch Preview
                </a>
              </Link>
            </div>
          ...
          <Col xl={{ span: 5, offset: 1 }} lg={6} md={12}>
            ...
            <Card style={{ zIndex: 1 }}>
              ...
              <Card.Footer className="bg-white px-6 py-4">
                <p className="mb-0">
                  ...
                  <Link href="#">
                    <a className="text-inherit fw-semi-bold">Terms of Use</a>
                  </Link>
                  ,
                  <Link href="#">
                    <a className="text-inherit fw-semi-bold">Privacy Policy</a>
                  </Link>
                  , and{" "}
                  <Link href="#">
                    <a className="text-inherit fw-semi-bold">Data Policy</a>
                  </Link>
                </p>
              </Card.Footer>
            </Card>
            ...
            <div className="position-relative">
              <div className="position-absolute bottom-0 end-0 me-md-n3 mb-md-n6 me-lg-n4 mb-lg-n4 me-xl-n6 mb-xl-n8 d-none d-md-block ">
                <Image
                  src="/images_optimized/pattern/dots-pattern.svg"
                  alt=""
                />
              </div>
            </div>
